...
# covid data
cv <- read_csv(paste0(my_path,'raw/covid_02_11_2020_raw.csv'))
...
# 3rd drop values with certain starting character
...
for ( i in seq_along( use_name ) ){
  df$country[ df$country == use_name[ i ] ] <- alter_name[ i ]
}
...
my_path <- "~/Documents/CEU/Courses/2020_Fall/Mandatory/DA2/DA2_Assignment/data/"
# COVID data
write_csv( df , paste0(my_path,'clean/covid_pop_02_11_2020_clean.csv'))
